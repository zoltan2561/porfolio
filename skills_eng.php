<section id="technologiak">
  ...
  <h3>🧠 Backend</h3>
  <ul>
    <li>PHP (OOP, Laravel – advanced level)</li>
    <li>Java (Swing, basic Spring knowledge)</li>
    <li>Python (scripts, automation)</li>
  </ul>

  <h3>💽 Databases</h3>
  <ul>
    <li>MySQL / MariaDB – advanced queries, normalization, indexing, data modeling</li>
    <li>Oracle SQL (PL/SQL, stored procedures, query optimization)</li>
  ...
  <ul>
    ...
    <li>Routers, switches, APs (TP-Link, MikroTik, Ubiquiti, Cisco Meraki)</li>
    <li>Active Directory and access control in local networks</li>
    <li>Samba file shares in Linux environments</li>
    <li>Network diagnostics, IP addressing, DHCP, port forwarding, VLANs</li>
  </ul>

  <h3>📦 Automation & Backup Systems</h3>
  <ul>
    <li>Urbkacup – custom automated backup system development</li>
  ...
  <ul>
    <li>Diving deeper into Spring Boot and REST API development</li>
